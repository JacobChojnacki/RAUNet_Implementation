...
def Attention_residual_unet_model(shape=(128, 128, 3),
    ...
    d1 = decoder_residual_block(b1, att_4, filter_multiplier[2] * num_filters, kernel_size, dropout=0.1, batch_norm=batch_norm)
    ...
    d2 = decoder_residual_block(d1, att_3, filter_multiplier[1] * num_filters, kernel_size, dropout=0.1, batch_norm=batch_norm)
    ...
    d3 = decoder_residual_block(d2, att_2, filter_multiplier[0] * num_filters, kernel_size, dropout=0.1, batch_norm=batch_norm)

    gating_1 = gating_signal(d3, num_filters, batch_norm)
    att_1 = attention_block(s1, gating_1, num_filters, name="attention_4")
    d4 = decoder_residual_block(d3, att_1, num_filters, kernel_size, dropout=0.1, batch_norm=batch_norm)
